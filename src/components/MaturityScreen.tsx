...
function EventCard({
  ...
  event: typeof MATURITY_EVENTS[0];
  character: Character;
  eventIndex: number;
  totalEvents: number;
  isActive: boolean;
...
export default function MaturityScreen({
  ...
  const handleChoice = (option: EventOption) => {
    ...
    if (currentEvent + 1 >= MATURITY_EVENTS.length) {
      setAllDone(true);
    } else {
          ...
          {MATURITY_EVENTS.map((event, i) => {
            ...
            return (
              <EventCard
                ...
                eventIndex={i}
                totalEvents={MATURITY_EVENTS.length}
          ...
          >
            ...
            <div style={{
              ...
              <p className="cinzel" style={{
                ...
                Lo que encontraste en estos años
              </p>
