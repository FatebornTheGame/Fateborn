...
function OptionButton({
  ...
  return (
    ...
    >
      ...
      {/* Consequence — solo visible tras seleccionar */}
      {selected && (
        <p className="crimson" style={{
          margin: '10px 0 0',
          fontSize: '13px',
...
function EventCard({
  ...
  event: typeof CHILDHOOD_EVENTS[0];
  character: Character;
  eventIndex: number;
  totalEvents: number;
  isActive: boolean;
...
export default function ChildhoodScreen({
  ...
  const handleChoice = (option: EventOption) => {
    ...
    if (currentEvent + 1 >= CHILDHOOD_EVENTS.length) {
      setAllDone(true);
    } else {
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        {/* Events — show current and all completed above */}
        <div style={{
          width: '100%',
          display: 'flex',
          flexDirection: 'column',
          ...
          {CHILDHOOD_EVENTS.map((event, i) => {
            ...
            return (
              <EventCard
                ...
                eventIndex={i}
                totalEvents={CHILDHOOD_EVENTS.length}
          ...
          >
            ...
            <div style={{
              ...
              <p className="cinzel" style={{
                ...
                Lo que aprendiste en estos años
              </p>
