...
import { YOUTH_EVENTS, type EventOption } from '../data/youthEvents';
...
export default function YouthScreen({
  ...
  const handleChoice = (option: EventOption) => {
    ...
    if (currentEvent + 1 >= YOUTH_EVENTS.length) {
      setAllDone(true);
    } else {
          ...
          {YOUTH_EVENTS.map((event, i) => {
            ...
            return (
              <EventCard
                ...
                eventIndex={i}
                totalEvents={YOUTH_EVENTS.length}
