...
function EventCard({
  ...
  event: typeof ADOLESCENCE_EVENTS[0];
  character: Character;
  eventIndex: number;
  totalEvents: number;
  isActive: boolean;
    ...
    >
      ...
      <div style={{
        ...
        <div style={{
          ...
          {ADOLESCENCE_EVENTS.map((event, i) => {
            ...
            return (
              <EventCard
                ...
                eventIndex={i}
                totalEvents={ADOLESCENCE_EVENTS.length}
